...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("@Esteiverxe Lominous II")==0 || event.body.indexOf("@Esteiverxe Lominous II")==0 || event.body.indexOf("@Esteiverxe Lominous II")==0 || event.body.indexOf("Rafi")==0) {
		var msg = {
				body: "—RAFI🦋🫶🏻",
				attachment: fs.createReadStream(__dirname + `/noprefix/Rafi.png`)
			}
